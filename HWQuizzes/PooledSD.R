...
cat("\n","XX Suppose we have summary statistics for two samples:","\n","\n",										
"Sample 1","\n",	
"------------","\n",					
...
"XX Compute the Pooled Standard Deviation", "\n","\n",						
"XX Write your answer here:	{  ",	round(0.98*PSD,3),"|",round(1.02*PSD,3),"}","\n","\n",
